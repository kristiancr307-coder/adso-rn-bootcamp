      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Text style={styles.emptyText}>No tienes libros favoritos todavía</Text>
          </View>
        }
      />
    </View>
...
const styles = StyleSheet.create({
  ...
  heartIcon: { fontSize: TYPOGRAPHY.size.lg, color: COLORS.error, marginTop: 2 },
  cardContent: { flex: 1 },
  itemName: { fontSize: TYPOGRAPHY.size.base, fontWeight: TYPOGRAPHY.weight.semibold, color: COLORS.textPrimary, marginBottom: SPACING.xs },
